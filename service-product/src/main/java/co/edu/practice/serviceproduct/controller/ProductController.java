package co.edu.practice.serviceproduct.controller;
...
import static org.hibernate.type.descriptor.JdbcBindingLogging.LOGGER;
...
public class ProductController {
    ...
    public ResponseEntity<Product> updateStockProduct(@PathVariable("id") Long id, @RequestParam(name = "quantity") Double quantity){
        ...
        return (productUpdate == null) ? ResponseEntity.notFound().build() : ResponseEntity.ok(productUpdate);
    }
